...
const TENANT_CODE_ELEVE       = 'NOURA2026E'; // /#/NOURA2026E  — élèves
const TENANT_CODE_ENSEIGNANT  = 'NOURA2026P'; // /#/NOURA2026P  — professeurs
const TENANT_CODE_CAISSIER    = 'NOURA2026C'; // /#/NOURA2026C  — comptabilité
const TENANT_CODE_ADMIN       = 'NOURA2026A'; // /#/NOURA2026A  — administration
const TENANT_CODE_SURVEILLANT = 'NOURA2026S'; // /#/NOURA2026S  — surveillance/secrétariat
const TENANT_CODE_RH          = 'NOURA2026R'; // /#/NOURA2026R  — ressources humaines
